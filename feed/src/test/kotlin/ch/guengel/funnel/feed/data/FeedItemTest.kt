...
internal class FeedItemTest {
    ...
    @Test
    fun `are equal`() {
        val item1 = FeedItem("id", "title 1", "link 1", now)
        val item2 = FeedItem("id", "title 2", "link 2", now)
    ...
    fun `non-equal hash value`() {
        val item1 = FeedItem("id1", "title 1", "link 1", now)
        val item2 = FeedItem("id2", "title 2", "link 2", now)
    ...
    fun `compare non-equal feed items`() {
        ...
        val item1 = FeedItem("id", "title 1", "link 1", now)
        val item2 = FeedItem("id", "title 2", "link 2", time2)
