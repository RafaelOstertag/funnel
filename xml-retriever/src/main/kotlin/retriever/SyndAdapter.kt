...
internal class SyndAdapter {
    ...
    private fun extractFeedItem(syndEntry: SyndEntry): FeedItem {
        ...
        return FeedItem(syndEntry.uri, syndEntry.title, createdDate ?: FeedConstants.emptyCreated)
    }
    ...
    private fun extractDateFromModules(syndEntry: SyndEntry): Date {
        ...
        if (module == null) {
            logger.warn("No way of extracting created date from {}", syndEntry.title)
    ...
    private companion object {
        val logger: Logger = LoggerFactory.getLogger(SyndAdapter::class.java)
    }
}